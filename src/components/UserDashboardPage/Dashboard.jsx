    ...
    <div style={{ display: 'flex', margin: '-24px' }}>
      ...
      >
        <Tabs defaultActiveKey="1" type="card" onChange={handleChangeTab}>
          <TabPane tab="PP quản lý vốn 1" key="1">
          ...
          <TabPane tab="PP quản lý vốn 2" key="2">
            <Form layout="vertical">
              <div
                style={{
                  marginBottom: '10px',
              ...
              >
                ...
                <Select
                  ...
                  disabled={isTrading}
                >
                  <Option value="8">Phương pháp 1</Option>
                  <Option value="9">Phương pháp 2</Option>
                  <Option value="10">Phương pháp 3</Option>
                  <Option value="11">Phương pháp 4</Option>
                  <Option value="12">Phương pháp 5</Option>
                  <Option value="13">Phương pháp 6</Option>
                </Select>
              </div>
              <div
                style={{
          ...
          <TabPane tab="PP quản lý vốn 3" key="3">
            <Form layout="vertical">
              <div
                style={{
                  marginBottom: '10px',
              ...
              >
                ...
                <Select
                  ...
                  disabled={isTrading}
                >
                  <Option value="14">Phương pháp 1</Option>
                  <Option value="15">Phương pháp 2</Option>
                  <Option value="16">Phương pháp 3</Option>
                  <Option value="17">Phương pháp 4</Option>
                  <Option value="18">Phương pháp 5</Option>
                  <Option value="19">Phương pháp 6</Option>
                  <Option value="20">Phương pháp 7</Option>
                </Select>
              </div>
              <div
                style={{
